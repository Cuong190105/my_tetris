...
all : $(OBJS)
	...
	g++ $(OBJS) -I src\include\SDL2 -L src\lib -L src\bin -w -Wl,-subsystem,console -lmingw32 -lwsock32 -lWs2_32 -lSDL2main -lSDL2_image -lSDL2_ttf -lSDL2_mixer -lSDL2 -o $(OBJ_NAME)
